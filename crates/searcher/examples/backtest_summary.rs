...
fn synthetic_dataset() -> Vec<LabelledTx> {
    ...
    let uniswap_v3 = [
        0x68, 0xb3, 0x46, 0x58, 0x33, 0xfb, 0x72, 0xa7, 0x0e, 0xcd, 0xf4, 0x85, 0xe0, 0xe4,
        0xc7, 0xbd, 0x86, 0x65, 0xfc, 0x45,
    ];
    let one_inch = [
        0x11, 0x11, 0x11, 0x12, 0x54, 0xee, 0xb2, 0x54, 0x77, 0xb6, 0x8f, 0xb8, 0x5e, 0xd9,
        0x29, 0xf7, 0x3a, 0x96, 0x05, 0x82,
    ];
